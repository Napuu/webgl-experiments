import{S as on,e as V,r as W,c as S,m as F,a as u,b as en,g as v,o as an}from"./utils.405aee69.js";var sn=`#version 300 es
in vec2 oldPosition;
in vec2 oldVelocity;
...
void main() {
  ...
  outColor = color;
}`;const _=new on,mn=new URLSearchParams(document.location.search);mn.get("stats")&&(_.showPanel(0),document.body.appendChild(_.dom));let C=!1,g=[-1,-1],h=0;const un=1;function vn(){const o=document.querySelector("canvas");if(!o){V("Canvas not found");return}window.addEventListener("resize",()=>W(o)),W(o);const B=t=>{if(!(t.type==="mousemove"&&!C)){if(t.type==="touchmove"){const e=t;g=[e.touches[0].clientX,o.height-e.touches[0].clientY]}else{const e=t;g=[e.clientX,o.height-e.clientY]}h=1}},w=t=>{C=t};o.addEventListener("mousedown",()=>w(!0)),o.addEventListener("mouseup",()=>w(!1)),o.addEventListener("mousemove",B),o.addEventListener("touchstart",()=>w(!0)),o.addEventListener("touchmove",B),o.addEventListener("touchend",()=>w(!1));const n=o.getContext("webgl2");if(!n){V("WebGL2 context not found");return}const l=S(n,sn,rn,["newPosition"]),i=S(n,cn,ln,["newVelocity"]),y=S(n,dn,fn);if(!l||!y||!i){V("Program compilation failed");return}const d={oldPosition:n.getAttribLocation(l,"oldPosition"),oldVelocity:n.getAttribLocation(l,"oldVelocity"),canvasDimensions:n.getUniformLocation(l,"canvasDimensions"),deltaTime:n.getUniformLocation(l,"deltaTime")},a={oldPosition:n.getAttribLocation(i,"oldPosition"),oldVelocity:n.getAttribLocation(i,"oldVelocity"),gravityPosition:n.getUniformLocation(i,"gravityPosition"),reset:n.getUniformLocation(i,"reset"),canvasDimensions:n.getUniformLocation(i,"canvasDimensions"),deltaTime:n.getUniformLocation(i,"deltaTime")},A={position:n.getAttribLocation(y,"position"),velocity:n.getAttribLocation(y,"velocity"),matrix:n.getUniformLocation(y,"matrix")},P=Math.min(Math.floor(n.canvas.width*n.canvas.height*.3),1e6),N=(t,e)=>new Array(t).fill(0).map(()=>e.map(s=>en(...s))).flat(),I=new Float32Array(N(P,[[-o.width,o.width],[-o.height,o.height]])),p=50,k=new Float32Array(N(P,[[-p,p],[-p,p]])),f=F(n,I,n.DYNAMIC_DRAW),x=F(n,I,n.DYNAMIC_DRAW),m=F(n,k,n.DYNAMIC_DRAW),M=F(n,k,n.DYNAMIC_DRAW);if(!f||!x||!m||!M){V("Something wrong with buffers");return}const q=u(n,[[f,d.oldPosition],[m,d.oldVelocity]]),$=u(n,[[x,d.oldPosition],[m,d.oldVelocity]]),G=u(n,[[f,a.oldPosition],[m,a.oldVelocity]]),X=u(n,[[f,a.oldPosition],[M,a.oldVelocity]]),Z=u(n,[[f,A.position],[m,A.velocity]]),j=u(n,[[x,A.position],[M,A.velocity]]);function R(t,e){const s=t.createTransformFeedback();return t.bindTransformFeedback(t.TRANSFORM_FEEDBACK,s),t.bindBufferBase(t.TRANSFORM_FEEDBACK_BUFFER,0,e),s}const H=R(n,f),J=R(n,x),Q=R(n,m),nn=R(n,M);n.bindBuffer(n.ARRAY_BUFFER,null),n.bindBuffer(n.TRANSFORM_FEEDBACK_BUFFER,null);let c={updatePositionVA:q,updateVelocityVA:G,tfPosition:J,tfVelocity:nn,drawVA:j},O={updatePositionVA:$,updateVelocityVA:X,tfPosition:H,tfVelocity:Q,drawVA:Z},U=0;function z(t){if(_.begin(),!n){V("WebGL2 context lost during rendering?");return}h>0&&(h+=1,h>un&&(h=0)),t*=.001;const e=t-U;U=t,n.clear(n.COLOR_BUFFER_BIT),n.useProgram(l),n.bindVertexArray(c.updatePositionVA),n.uniform2f(d.canvasDimensions,n.canvas.width,n.canvas.height),n.uniform1f(d.deltaTime,e),n.enable(n.RASTERIZER_DISCARD),n.bindTransformFeedback(n.TRANSFORM_FEEDBACK,c.tfPosition),n.beginTransformFeedback(n.POINTS),n.drawArrays(n.POINTS,0,P),n.endTransformFeedback(),n.bindTransformFeedback(n.TRANSFORM_FEEDBACK,null);const[s,b]=g[0]===-1?[n.canvas.width/2,n.canvas.height/2]:g,r=100,K=200,Y=2,T=Math.max(n.canvas.width/K,Y),D=Math.max(n.canvas.height/K,Y);let E=s+v()*T,L=b+v()*D;s<r?E=r+v()*T:s>n.canvas.width-r&&(E=n.canvas.width-r+v()*T),b<r?L=r+v()*D:b>n.canvas.height-r&&(L=n.canvas.height-r+v()*D),C||(g=[E,L]),n.useProgram(i),n.bindVertexArray(c.updateVelocityVA),n.uniform2f(a.gravityPosition,...g),n.uniform1i(a.reset,h),n.uniform2f(a.canvasDimensions,n.canvas.width,n.canvas.height),n.uniform1f(a.deltaTime,e),n.bindTransformFeedback(n.TRANSFORM_FEEDBACK,c.tfVelocity),n.beginTransformFeedback(n.POINTS),n.drawArrays(n.POINTS,0,P),n.endTransformFeedback(),n.bindTransformFeedback(n.TRANSFORM_FEEDBACK,null),n.disable(n.RASTERIZER_DISCARD),n.useProgram(y),n.bindVertexArray(c.drawVA),n.viewport(0,0,n.canvas.width,n.canvas.height),n.uniformMatrix4fv(A.matrix,!1,an(0,n.canvas.width,0,n.canvas.height,-1,1)),n.drawArrays(n.POINTS,0,P);{const tn=c;c=O,O=tn}_.end(),requestAnimationFrame(z)}requestAnimationFrame(z)}vn();
